/**
 * GET /api/public/doctors/[id]/references
 * Returns AI-enrichment source references for a doctor, grouped by field.
 */
...
export async function GET(_req: NextRequest, { params }: Params) {
  ...
  const rows = await db
    ...
    .where(
      and(
        eq(ingestionFieldConfidences.entityType, "doctor"),
