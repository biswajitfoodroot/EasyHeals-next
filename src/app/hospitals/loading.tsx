  ...
  return (
    <div style={{ minHeight: "100dvh", background: "#fff", padding: "76px 16px 28px" }}>
      ...
      <div style={{ width: "min(1180px, 100%)", margin: "0 auto", borderRadius: "20px", border: "1.5px solid #D0E4D8", background: "linear-gradient(135deg, #F8FAF9, #EDF5F0)", padding: "20px" }}>
        <div style={{ width: "80px", height: "20px", borderRadius: "999px", background: "#D0E4D8", marginBottom: "12px" }} className="animate-pulse" />
        <div style={{ width: "60%", height: "36px", borderRadius: "10px", background: "#D0E4D8", marginBottom: "10px" }} className="animate-pulse" />
        <div style={{ width: "80%", height: "16px", borderRadius: "8px", background: "#E8F0EC" }} className="animate-pulse" />
        {/* Search bar skeleton */}
          ...
          <div key={i} style={{ borderRadius: "16px", border: "1.5px solid #D0E4D8", background: "#fff", padding: "14px", display: "grid", gap: "10px" }}>
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              ...
              <div style={{ flex: 1, display: "grid", gap: "6px" }}>
                <div style={{ height: "15px", borderRadius: "6px", background: "#D0E4D8", width: "70%" }} className="animate-pulse" />
                <div style={{ height: "12px", borderRadius: "6px", background: "#E8F0EC", width: "50%" }} className="animate-pulse" />
              </div>
            </div>
