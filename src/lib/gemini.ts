...
const CITY_HINTS = [
  ...
  "Kochi", "Visakhapatnam", "Indore", "Bhopal", "Lucknow",
  "Dhaka", "Chittagong", "Colombo", "Kathmandu", "Yangon",
  "Dubai", "Abu Dhabi", "Sharjah", "Muscat", "Riyadh", "Jeddah",
  "Kuwait City", "Doha", "Manama", "Nairobi", "Lagos", "Cairo",
];
