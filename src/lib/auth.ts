...
export type RoleCode = "owner" | "admin" | "admin_manager" | "admin_editor" | "advisor" | "viewer" | "hospital_admin" | "doctor" | "contributor" | "receptionist" | "operator" | "coordinator";
...
async function findSession(
  ...
  const record = row[0];
  const validRoles: RoleCode[] = ["owner", "admin", "admin_manager", "admin_editor", "advisor", "viewer", "hospital_admin", "doctor", "contributor", "receptionist", "operator", "coordinator"];
